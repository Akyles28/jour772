...
For this exercise, you will create PDFs of two Find a Grave websites, extract the data from the pdfs, clean it up and produce a single spreadsheet.
...
```{r}
text <- pdf_text("C:/Users/AKBas/Documents/GitHub/jour772/Cheltenham/Jessup (0-20) - Virtual Cemetery.pdf")
...
**I think so, but the structure makes it hard to fully tell. :**
...
hor_clean <- index |> 
  rename(name = index) |> 
  mutate(str_split(index, " "))
```

## Align the data

This complex code chunk is performing the following tasks:
