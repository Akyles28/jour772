...
```{r}
baltimore_911_with_demographics |> 
  filter(str_detect(zip_code, "21205") & medage) |> 
  group_by(neighborhood, zip_code, medage) |> 
  summarise()
```
...
**Write the answer here:**
###Some of the neighborhoods include Armistead Gardens, Biddle Street, Ellwood Park/Monument, Gay Street, Kresson, Madison-Eastend, McElderry Park and Milton-Montford. I can say that the Baltimore population is majority Black and the median age for the area is 30.6. 
